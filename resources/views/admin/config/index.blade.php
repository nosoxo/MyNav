                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <select name="type">
                                        <option value="">请选择</option>
                                        @foreach(\App\Enums\ConfigTypeEnum::attrs () as $ind => $item)
...
{{--                    <button class="layui-btn layui-btn-sm data-add-btn" lay-event="add"> 添加</button>--}}
            ...
            <script type="text/html" id="currentTableBar">
                ...
                <a class="layui-btn layui-btn-xs layui-btn-primary" lay-event="view">{{__('message.buttons.show')}}</a>
                @endif
    ...
    <script>
        layui.use(['form', 'table','laydate'], function () {
            ...
            table.render({
                ...
                cols: [[
                    {field:'group_id',title: '配置分类',width:100,sort:true},
                    {field:'type',title: '类型',width:100,sort:true},
                    {field:'title',title: '配置名称',sort:true},
                    {field:'content',title: '配置内容',sort:true},
                    {field:'created_at',title: '记录时间',sort:true},
                    {field:'updated_at',title: '记录时间',sort:true},
